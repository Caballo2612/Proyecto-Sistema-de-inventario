            ...
            <div className='ml-auto mr-4 flex items-center gap-2 group cursor-pointer' onClick={() => toggleMenu('settings')}>
                ...
                {Isopen.settings && (
                    <div className='absolute right-4 top-16 bg-white text-black rounded-md shadow-lg w-46 z-10 p-2'>
                        ...
                        <div className='flex hover:bg-gray-200 p-2 cursor-pointer text-lg flex-row items-center gap-2 rounded-md'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 16 16"><path d="M1.3 3.75h5.88V2.5H1.3A1.25 1.25 0 0 0 .05 3.75v8.5A1.25 1.25 0 0 0 1.3 13.5h5.88v-1.25H1.3z"/><path d="m15.4 7-4-2.74-.71 1 3.08 2.1H4.71v1.26h9.07l-3.08 2.11.71 1L15.4 9a1.24 1.24 0 0 0 0-2"/></svg>
                            <span>
                                Cerrar Sesión
                            </span>
                        </div>
